...
#ifndef NOTCHISLAND_SWIFT_H
#define NOTCHISLAND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotchIsland",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11NotchIsland11AppDelegate")
...
SWIFT_CLASS("_TtC11NotchIsland11NotchWindow")
@interface NotchWindow : NSWindow
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC11NotchIsland22ShortcutRecorderNSView")
...
@class CLLocation;
SWIFT_CLASS("_TtC11NotchIsland14WeatherManager")
